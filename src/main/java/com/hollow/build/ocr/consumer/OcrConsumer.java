package com.hollow.build.ocr.consumer;
 ...
 * <p>
 * 当生产者（{@link com.hollow.build.ocr.service.impl.OcrServiceImpl}）向队列发送 OCR 任务消息后，
 * 本类会自动拉取消息并执行以下操作：
 * <ol>
...
public class OcrConsumer {
     ...
     * <p>
     * 消息结构（来自 {@link com.hollow.build.ocr.service.impl.OcrServiceImpl}）：
     * <ul>
